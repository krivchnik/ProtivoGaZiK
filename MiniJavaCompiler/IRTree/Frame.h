...
public:
    virtual ~IAddress() {}
    virtual std::shared_ptr<const CExpression> ToExpression( std::shared_ptr<const CExpression> framePointer ) const = 0;
};
...
public:
    ...
    virtual std::shared_ptr<const CExpression> ToExpression( std::shared_ptr<const CExpression> framePointer ) const override;
protected:
    int offset;
};
...
public:
    ...
    std::shared_ptr<const CExpression> ToExpression( std::shared_ptr<const CExpression> thisPointer ) const override;
};
...
public:
    ...
    std::shared_ptr<const CExpression> ToExpression( std::shared_ptr<const CExpression> framePointer ) const override;
private:
    CTemp temp;
};
